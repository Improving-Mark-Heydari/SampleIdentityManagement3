...
namespace GB.IdentityServer.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //private Task BuildLoginViewModelAsync(string returnUrl)
        //{
        ...
        //public async Task<IActionResult> Logout(string logoutId) =>
            ...
            //if ((await BuildLogoutViewModelAsync(logoutId)).ShowLogoutPrompt != false)
            //{
            //    return View(await BuildLogoutViewModelAsync((string)logoutId));
            //}
